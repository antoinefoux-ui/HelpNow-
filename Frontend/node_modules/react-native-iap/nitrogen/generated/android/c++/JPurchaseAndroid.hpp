...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    PurchaseAndroid toCpp() const {
      ...
      static const auto fieldPendingPurchaseUpdateAndroid = clazz->getField<JPendingPurchaseUpdateAndroid>("pendingPurchaseUpdateAndroid");
      jni::local_ref<JPendingPurchaseUpdateAndroid> pendingPurchaseUpdateAndroid = this->getFieldValue(fieldPendingPurchaseUpdateAndroid);
  ...
  public:
    ...
    static jni::local_ref<JPurchaseAndroid::javaobject> fromCpp(const PurchaseAndroid& value) {
      using JSignature = JPurchaseAndroid(jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JArrayClass<jni::JString>>, jni::alias_ref<jni::JBoolean>, jboolean, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<JPendingPurchaseUpdateAndroid>, jni::alias_ref<JIapPlatform>, jni::alias_ref<jni::JString>, jni::alias_ref<JPurchaseState>, jni::alias_ref<jni::JString>, double, jni::alias_ref<jni::JString>, jni::alias_ref<JIapStore>, double, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
      ...
      return create(
        ...
        value.pendingPurchaseUpdateAndroid.has_value() ? JPendingPurchaseUpdateAndroid::fromCpp(value.pendingPurchaseUpdateAndroid.value()) : nullptr,
