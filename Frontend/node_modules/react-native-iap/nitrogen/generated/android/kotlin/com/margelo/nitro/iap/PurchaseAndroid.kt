...
data class PurchaseAndroid(
  ...
  @DoNotStrip
  @Keep
  val pendingPurchaseUpdateAndroid: PendingPurchaseUpdateAndroid?,
  @DoNotStrip
  @Keep
  ...
  private companion object {
    ...
    @Suppress("unused")
    @JvmStatic
    private fun fromCpp(autoRenewingAndroid: Boolean?, currentPlanId: String?, dataAndroid: String?, developerPayloadAndroid: String?, id: String, ids: Array<String>?, isAcknowledgedAndroid: Boolean?, isAutoRenewing: Boolean, isSuspendedAndroid: Boolean?, obfuscatedAccountIdAndroid: String?, obfuscatedProfileIdAndroid: String?, packageNameAndroid: String?, pendingPurchaseUpdateAndroid: PendingPurchaseUpdateAndroid?, platform: IapPlatform, productId: String, purchaseState: PurchaseState, purchaseToken: String?, quantity: Double, signatureAndroid: String?, store: IapStore, transactionDate: Double, transactionId: String?): PurchaseAndroid {
