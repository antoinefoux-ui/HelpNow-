...
public extension PurchaseAndroid {
   ...
   */
  init(autoRenewingAndroid: Bool?, currentPlanId: String?, dataAndroid: String?, developerPayloadAndroid: String?, id: String, ids: [String]?, isAcknowledgedAndroid: Bool?, isAutoRenewing: Bool, isSuspendedAndroid: Bool?, obfuscatedAccountIdAndroid: String?, obfuscatedProfileIdAndroid: String?, packageNameAndroid: String?, pendingPurchaseUpdateAndroid: PendingPurchaseUpdateAndroid?, platform: IapPlatform, productId: String, purchaseState: PurchaseState, purchaseToken: String?, quantity: Double, signatureAndroid: String?, store: IapStore, transactionDate: Double, transactionId: String?) {
    ...
    }(), { () -> bridge.std__optional_PendingPurchaseUpdateAndroid_ in
      if let __unwrappedValue = pendingPurchaseUpdateAndroid {
        return bridge.create_std__optional_PendingPurchaseUpdateAndroid_(__unwrappedValue)
      } else {
        return .init()
      }
  ...
  var pendingPurchaseUpdateAndroid: PendingPurchaseUpdateAndroid? {
    @inline(__always)
    get {
      return self.__pendingPurchaseUpdateAndroid.value
    }
    @inline(__always)
    set {
      self.__pendingPurchaseUpdateAndroid = { () -> bridge.std__optional_PendingPurchaseUpdateAndroid_ in
        if let __unwrappedValue = newValue {
          return bridge.create_std__optional_PendingPurchaseUpdateAndroid_(__unwrappedValue)
        } else {
          return .init()
