...
class EmergencyController {
   ...
   */
  async getActiveEmergency(req: Request, res: Response, next: NextFunction) {
    try {
   ...
   */
  async getNearbyEmergencies(req: Request, res: Response, next: NextFunction) {
    try {
   ...
   */
  async getEmergencyHistory(req: Request, res: Response, next: NextFunction) {
    try {
      const { userId } = req.params;
  ...
  async acceptEmergency(req: Request, res: Response, next: NextFunction) {
    ...
    try {
      ...
      const checkResult = await client.query(
        `SELECT status, accepted_helper_id FROM emergency_requests WHERE id = $1`,
        [id]
      );
      ...
      const { status, accepted_helper_id } = checkResult.rows[0];
   ...
   */
  async updateHelperLocation(req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
   ...
   */
  async markHelperArrived(req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
   ...
   * Resolve emergency
   */
  async resolveEmergency(req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
   ...
   * Upload voice note
   */
  async uploadVoiceNote(req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
